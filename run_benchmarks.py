...
def main():
        ...
        for num_cities in num_cities_list:
            for population_size in population_sizes:
                for total_generations in total_generations_dict[cores]:
                    parameter_sets.append((cores, num_cities, population_size, total_generations))
    ...
    for i, params in enumerate(parameter_sets):
        ...
        run_benchmark(cores, num_cities, population_size, total_generations, mutation_rate, tournament_size, result_file)
